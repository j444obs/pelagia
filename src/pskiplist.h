 ...
 * Otherwise behaves the same as plg_skiplistAdd. */
bool plg_skiplistSet(struct skiplist *sl,
 ...
 * (not necessarily the first) is deleted; see plg_skiplistDeleteAll. */
 ...
 * return behavior as plg_skiplistFirst/last, but also deletes the pair. */
...
void plg_skiplistIter(struct skiplist *sl,
